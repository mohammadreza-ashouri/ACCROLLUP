...
contract Configurable {
  ...
  /**
   * @dev tokenDecimals
   * @notice Decimal places for the token on ACCROLLUP.
  ...
  /**
   * @dev version
   * @notice Current version number for the ACCROLLUP system.
   */
  ...
  /**
   * @dev tokenContract
   * @notice The address of the token contract used by ACCROLLUP.
   */
